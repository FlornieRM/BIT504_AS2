...
import java.awt.Graphics2D;
	...
	public class Cell 
	{
		...
		// Method to set the content of this cell
	...
	public void clear() 
		...
		/* 
		This code sets the content of the cell to the EMPTY value of the Player enum. Note that I'm assuming 
		that the enum is named Player and it has an EMPTY value. If my enum is named differently or has a 
		different value for empty cells, I'll need to adjust the code accordingly.
		*/
		}
